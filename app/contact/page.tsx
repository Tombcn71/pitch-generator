              ...
              <div className="flex flex-col sm:flex-row gap-6 items-center">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    deliver compelling presentations. Specialized in the David Beckett pitch canvas methodology.
                  </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>One-on-one pitch review session</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Delivery tips and techniques</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <div className="sm:flex">
                ...
                <div className="p-6 sm:w-2/3">
                  ...
                  <CardDescription className="mb-4 text-base">
                    ...
                    every aspect of creating and delivering compelling pitches that win over investors, clients, and
                    stakeholders.
                  </CardDescription>
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        ...
                        <span className="text-sm ml-1">4.9/5 (120+ reviews)</span>
                      </div>
                    </div>
